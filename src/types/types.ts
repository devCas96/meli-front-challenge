...
export interface IBaseProductLocal {
  author: IAuthor;
  categories: ICategory[];
}

export interface IFullProductLocal extends IBaseProductLocal {
  item: IFullItem;
}
export interface IProductsLocal extends IBaseProductLocal {
  items: IItem[];
}
...
export interface IMostRepeatedCategory {
  [key: string]: number
}
export interface IItemsReduce {
  items: IItem[];
  mostRepeatedCategory: IMostRepeatedCategory
}
...
export interface IDescriptionServices {
  text: string;
  plain_text: string;
  last_updated: Date;
  date_created: Date;
...
export interface ICategoryServices {
  ...
  settings: ICategoryServicesSettings;
...
export interface ICategoryServicesSettings {
